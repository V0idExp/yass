...
LUA_TARGET :=
OBJS = layout.o ui.o widget.o texture.o renderer.o text.o font.o error.o projectile.o asteroid.o utils.o enemy.o list.o main.o sprite.o memory.o matlib.o shader.o ioutils.o strutils.o script.o physics.o game.o
